...
# 🦁 XXD Panel 003｜긴장감 있는 선의 언어

### 사진의 방향, 연결, 압력과 전환을 조용하지만 긴장된 검은 개념선으로

[![Codex Skill](https://img.shields.io/badge/Codex-Skill-000000?style=flat-square)](./SKILL.md)
[![Four Modes](https://img.shields.io/badge/Modes-4-d75d32?style=flat-square)](#네-가지-출력-하나의-개념선-논리)
...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089959872876228689"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 003 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089959872876228689"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 003 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089959872876228689"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 003 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2089959872876228689"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 003 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 003 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 003 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 003 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 003 예시 8"></td>
  </tr>
</table>

## 추가 3:4 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 003의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 003 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 003 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 003 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 003 추가 상하 예시 4"></td>
  </tr>
</table>

> 추가 예시: 천샹 포스터 그룹에서 해당 천샹 포스터 그룹의 네 장을 파일명 순서로 사용하고, 이 Panel의 원본 브리프에 따라 16:9 좌우 구성과 영어 자동 생성 문구로 제작했습니다.

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2089959872876228689) · 2026-08-19<br>
> GPT2 x 转绘 x 带刺 x 线条 x 美学提示词 x VOL.003

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2089959872876228689">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 003의 미학적 의도를 보여 줄 뿐이며, 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 생성 참고나 현재 기본값이 되지 않습니다.

> 연속 검은 선 · 공공 의제 · 힘점 · 침묵의 여백 · 해방

XXD Panel 003는 Codex와 호환 에이전트를 위한 이미지 생성 Skill입니다. 사진 표면을 베끼지 않고 정체성과 관계를 고정한 뒤, 방향, 연결, 모순, 압력과 전환을 연속된 검은 손그림 선으로 압축합니다. 선은 가장자리에서 들어와 낮거나 옆쪽에서 감기고 교차하고 되접혀 조여진 다음 위나 바깥으로 풀려납니다.
...
**Panel 003**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진의 방향, 연결, 압력과 전환을 조용하지만 긴장된 검은 개념선으로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 003으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 003이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진의 방향, 연결, 압력과 전환을 조용하지만 긴장된 검은 개념선으로 |
| **한눈에 알아볼 특징** | 연속 검은 선 · 공공 의제 · 힘점 · 침묵의 여백 · 해방 |
...
```text
원본 사실 고정 → 사진에만 맞는 시각적 은유 찾기 → 손의 흔들림이 남은 가는 선으로 단순화 → 수채·과슈·색연필·파스텔 겹치기 → 따뜻한 종이 여백 확보 → 절제된 레트로 손글씨 추가
```

무관한 사진으로 바꿔도 주제, 은유, 동작, 팔레트, 문구가 거의 그대로 성립한다면 003이 아닙니다.

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- **원본에 근거한 힘:** 고유 단서를 남기고 방향, 연결, 모순, 압력, 전환을 증거가 있는 범위에서만 추출합니다.
- **사진 고유의 전환:** 동작, 구조, 환경, 감정에서 자연스럽고 영리한 시각적 은유 하나를 도출하며 고정된 장치를 씌우지 않습니다.
- **연속 검은 선:** 가장자리에서 들어와 낮거나 옆쪽에서 감기고 교차하고 되접혀 조여진 뒤 위나 바깥으로 풀립니다.
- **머뭇거리는 손 윤곽:** 가는 선에 압력 변화, 끊긴 자국과 열린 이음을 남기며 매끈한 벡터 윤곽을 피합니다.
- **가벼운 혼합 매체:** 투명한 수채 번짐, 무광 과슈, 색연필 해칭, 파스텔이나 크레용 입자, 드라이 브러시를 얇게 공존시킵니다.
- **침묵의 여백:** 차가운 흰색, 미색 또는 저채도 옅은 바탕을 넓게 남기고 선을 중앙이나 화면 전체에 채우지 않습니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 003의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-003 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-003 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-003 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-003 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-003 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-003 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 003 적용, 공통 설정은 한 번만 확정
/xxd-panel-003 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
...
Claude Code 사용자는 같은 폴더를 `~/.claude/skills/xxd-panel-003`에 연결할 수 있습니다. 설치 후 에이전트 세션을 다시 시작하세요.
...
- [Skill 워크플로](SKILL.md)
- [중문 런타임 어댑터](references/xxd-panel-003-prompt.zh-CN.md)
- [영문 런타임 어댑터](references/xxd-panel-003-prompt.en.md)
...
**사진 대신 구호를 외치지 말고, 한 선에 압력과 통과와 해방을 남기세요.**
